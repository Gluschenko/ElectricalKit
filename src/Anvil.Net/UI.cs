...
namespace Anvil.Net
{
    ...
    public class UI
    {
        ...
        //Не хочет работать
        /*public static void DestroyControls(Control Target) 
        {
            int Count = 0;
        ...
        public static Label CreateLabel(Rect rect, string name, string text, string font = "SegoeUI", int fontsize = 15) 
        {
            Label l = new Label();
